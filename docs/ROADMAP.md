...
1. [v2.5.0 - Extensibility & APIs](#v250---extensibility--apis)
2. [v2.6.0 - Cart Operations & Persistence](#v260---cart-operations--persistence)
3. [v2.7.0 - Security & Production Readiness](#v270---security--production-readiness)
4. [v3.0.0 - E-commerce Features (Major Release)](#v300---e-commerce-features-major-release)
